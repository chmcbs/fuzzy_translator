...
**Lifespan:** the model is preloaded at startup with FastAPI's lifespan hook. Loading can take a few minutes, which would be incredibly inefficient to do on every call.
